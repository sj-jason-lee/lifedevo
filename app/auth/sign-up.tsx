...
export default function SignUpScreen() {
  ...
  const confirmBorder = useAnimatedStyle(() => ({
    borderColor: interpolateColor(confirmFocus.value, [0, 1], [Colors.border, Colors.accent]),
  }));
          ...
          <Animated.View style={formFade}>
            ...
            <AnimatedView style={[styles.inputWrapper, styles.inputSpacing, confirmBorder]}>
              <TextInput
                ...
                onFocus={() => { confirmFocus.value = withTiming(1, { duration: 250 }); }}
                onBlur={() => { confirmFocus.value = withTiming(0, { duration: 250 }); }}
